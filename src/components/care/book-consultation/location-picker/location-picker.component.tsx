...
const LocationPicker = ({ value, onChange }: { value: string; onChange: (v: string) => void }) => {
    ...
    return (
        <>
            <Box className={styles['location-picker-container']}>
                <TextField
                    label="Location"
                    value={value}
                ...
                <Dialog open={open} onClose={() => setOpen(false)} classes={{ paper: styles['dialog-paper'] }}>
                    ...
                    <DialogContent className={styles['dialog-content']}>
                        <List className={styles['dialog-list']}>
                            ...
                            {locations.map((city) => (
                                <Box key={city}>
                                    <ListItem className={styles['dialog-list-item']}>
